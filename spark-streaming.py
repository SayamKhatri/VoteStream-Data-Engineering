...
if __name__ == "__main__":
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/Users/samkhatri/Desktop/Data Engineering/VoteStream-Data-Engineering/postgresql-42.7.5.jar")  
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/samkhatri/Desktop/Data Engineering/VoteStream-Data-Engineering/Checkpoints/Checkpoints1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/samkhatri/Desktop/Data Engineering/VoteStream-Data-Engineering/Checkpoints/Checkpoints2") \
        .outputMode("update") \
        .start()
